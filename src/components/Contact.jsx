      ...
      <div className="container mx-auto flex flex-col">
        ...
        <div className="grid md:grid-cols-2">
          <div className="py-4 px-8 w-full">
            ...
            <div className="mb-5 flex ms-4 sm:ms-6 gap-x-4 sm:gap-x-8">
            ...
            <div className="mb-5 flex ms-4 sm:ms-6 gap-x-4 sm:gap-x-8">
              ...
              <div>
                ...
                <div>
                  <span className="font-semibold">Aditya Parab - </span> +91
                  93723 48202
                  <br />
                  <span className="font-semibold">Viraj Sawant - </span> +91
                  91368 35165
                </div>
              </div>
            </div>
