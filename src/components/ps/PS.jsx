...
const PS = () => {
  const objects = [
    {
      ...
      videoLink:
        "https://drive.google.com/file/d/1umrlMxtnNo4I_jo4GaAV5rWuBHQ1GW75/view?usp=sharing",
    },
    {
      ...
      videoLink:
        "https://drive.google.com/file/d/1OFRO4vyWe_5LfRmYDh6vNpUXNkGEfPZ4/view?usp=sharing",
    },
    {
      ...
      videoLink:
        "https://drive.google.com/file/d/1oCLWrrGw8XGDJW3YhgdKRbUdx_uwT70p/view?usp=sharing",
    },
    {
      ...
      videoLink:
        "https://drive.google.com/file/d/1iw6t-drSzHRC6wrkHA8JguY-MKnrFGPN/view?usp=sharing",
    },
  ];
  ...
  return (
    <div
      id="domains"
      className="flex flex-col justify-center items-center w-full bg-black py-10 mb-16 mt-10 sm:mt-0 px-3"
    >
