      ...
      <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
        ...
        <div className="grid grid-cols-2 gap-4 mt-8">
          ...
          <img
            ...
            src={
              "https://images.unsplash.com/photo-1651649503984-5b5f3514d6f0?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OTR8fGxvZ2lzdGljc3xlbnwwfDF8MHx8fDA%3D"
            }
