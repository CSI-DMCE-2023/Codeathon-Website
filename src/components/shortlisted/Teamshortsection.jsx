        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div class=" rounded-lg shadow-lg p-6 transform  transition duration-300 border border-white/[0.2]">
              <div class="mb-8">
                <h3 class="text-2xl font-semibold text-cyan-400  text-center mx-auto">Problem Statement 1</h3>
              </div>
            ...
            <div class=" rounded-lg shadow-lg p-6 transform  transition duration-300 border border-white/[0.2]">
              <div class="mb-8">
                <h3 class="text-2xl font-semibold text-cyan-400  text-center">Problem Statement 2</h3>
              </div>
              <div className="flex-col gap-4">
            ...
            <div class=" rounded-lg shadow-lg p-6 transform  transition duration-300 border border-white/[0.2]">
              <div class="mb-8">
                <h3 class="text-2xl font-semibold text-cyan-400  text-center">Problem Statement 3</h3>
              </div>
              <div className="flex-col gap-4">
            ...
            <div class=" rounded-lg shadow-lg p-6 transform  transition duration-300 border border-white/[0.2]">
              <div class="mb-8">
                <h3 class="text-2xl font-semibold text-cyan-400  text-center">Problem Statement 4</h3>
              </div>
              <div className="flex-col gap-4">
