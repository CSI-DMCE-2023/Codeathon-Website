...
export default function TPOHRMeet() {
  ...
  return (
    <div>
      <section className="px-5 pt-5 md:pt-12 min-h-screen pattern flex flex-col justify-between gap-y-10">
        ...
        <div className="mx-auto text-center flex flex-col justify-center">
          <div className="max-w-5xl mx-auto my-auto">
            ...
            <p className="mt-6 md:mt-10 text-gray-300 text-sm md:text-lg max-w-3xl mx-auto text-justify">
            ...
            >
              ...
              <span className="relative inline-block border-2 border-white px-6 md:px-8 py-2 md:py-3 text-sm font-bold uppercase tracking-widest text-white group-hover:border-[#22D3EE] group-active:text-opacity-75">
                Join Us
              </span>
            </a>
          </div>
      ...
      {/* <section>
        <div className="container px-6 py-10 mx-auto flex flex-col">
          ...
          <div className="flex items-center mt-6 md:mt-8 justify-center">
            <div className="flex items-center p-1 border border-gray-700 gap-x-2 rounded-xl">
              <button
                onClick={() => setToggle("HR")}
                className={`px-12 py-2 text-sm font-medium text-white capitalize hover:bg-white hover:text-black ${
                  toggle === "HR" && "bg-white text-black px-16 md:px-24"
                } md:py-3 rounded-xl`}
              >
                HR
              </button>
              <button
                onClick={() => setToggle("TPO")}
                className={`px-12 py-2 text-sm font-medium text-white capitalize hover:bg-white hover:text-black ${
                  toggle === "TPO" && "bg-white text-black px-16 md:px-24"
                } md:py-3 rounded-xl`}
              >
                TPO
              </button>
          ...
          <div className="grid grid-cols-1 gap-8 mt-6 md:mt-8 md:grid-cols-2">
            {data[toggle].map((item) => (
              <div className="px-12 py-8 border rounded-xl group border-gray-700">
