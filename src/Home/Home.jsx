...
function LoadingFallback() {
  return <div className="w-full z-[100000]">Loading...</div>;
}
  ...
  return (
    <div id="vanta2" className="w-full h-screen bg-black">
      <div className="h-screen w-full flex items-center justify-center  overflow-hidden flex-col vanta overflow-x-hidden">
        ...
        <div className="flex-col w-full h-full z-50">
          {showContent ? (
            <Suspense fallback={<LoadingFallback />}>
              <Spline
                className=" scale-50 md:scale-150 md:w-full w-[120%] -ml-8 mt-20 md:ml-0"
                style={{
                  height: "50%",
                  width: "revert-layer",
        ...
        {/* <MaskContainer
          revealText={
            <div className="homeContent flex flex-col items-center gap-8 ">
              <p data-text="CODE-A-THON" className=" hometext text-center sm:text-5xl text-3xl md:text-7xl font-bold -m-8  mt-12 text-blue-700 mb-4">
              ...
              <div class="sp">
                ...
                <button class="sparkle-button w-96 max-md:w-60 md:mt-8 ">
                  ...
                  <span class="text text-white max-md:text-sm text-2xl">Apply with devfolio</span>
                </button>
